...
const Navbar = () => {
  return (
    <div className="flex items-center justify-between h-[64px] px-[20px] flex-shrink-0 ">
      <div className="flex items-center h-[64px] gap-[12px]">
        <div className="flex w-[32px] h-[32px] justify-center items-center gap-[10px]">
          <div className="w-[20px] h-[20px] flex-shrink-0 bg-white  rounded-full">
      ...
      <div className="flex items-center h-[56px] px-[8px] py-[16px] gap-[10px]">
        ...
        <div className="flex w-[40px] h-[40px] p-[10px] justify-center items-center gap-[10px] rounded-8 rounded-8 border border-gray-300  bg-white rounded-lg">
